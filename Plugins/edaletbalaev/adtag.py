...
ad = ['Əlösət Hay', 'Ələsgərr', 'Böcəyim', 'Şeytan', 'Mixəy', 'Dəvə', 'Cücə', 'Bayram Nurlu', 'Zürafə', 'ilkinin Ürəyi', 'Anakonda', 'Azərçay', 'Maşennik', 'Hüsnü Çoban', 'Dilavər', 'Pişik', 'Xoşqədəm', 'İlham Əliyev', 'Bülbül', 'Nadir', 'çəpiş', 'Boss', 'Ay Qız', 'Gülüstan', 'Fərrux Kişi', 'Makoran', 'Karamel 🍫', 'Lamiyə', 'Şəbnəm', 'Röya', 'Minnoş 🥰', 'Zeytun', 'Nergis ✨', 'Sümbül ☘️', 'Nilüfer ☘️', 'Yetər', 'Ərkinaz', 'Səməni', 'Paxlava', 'Şəkərbura', 'Qoz Fındıq', 'Alma', 'DTX', 'Tospik 🐢', 'Tısbağa', 'Quzu', 'Ceyran', 'Dəcəl', 'Qara Qız', 'Ay Dili Dili', 'Günəbaxan', 'Qüdrət', 'Kalxoz', 'Göyərçin', 'Abdulla']
