...
async def start(event):
  ...
  if event.is_group:
    return await edalet.send_message(event.chat_id, f"** [Bayram](http://t.me/BayramTagBot)'un Əmrlər üçün?.Bot'a daxil olub.**", buttons=(
                     [Button.url('💡Bota Keç','https://t.me/BayramTagBot?start=start')],
               [Button.url('Music Bot 🎵', 'https://t.me/QaqliMusicBot'),
          Button.url('Support', 'https://t.me/ilkinsupport')],
                    ),
                    link_preview=False)
